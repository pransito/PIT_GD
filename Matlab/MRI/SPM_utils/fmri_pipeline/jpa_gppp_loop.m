...
% ID with ','!
ss_level.gen.includeList = {'VPPG0115'};                                   % default: {''},i.e. all IDs will be part of the test
...
ss_level.gppi.FirstLVLModel={'MRT\NIFTI\PDT\results\PDT_ss_design_NOV'};
...
base_path_ROIs = ['F:\data\results_2nd_level\twottest\groupstats_MRT' ... 
                  '\NIFTI\PDT\results\ROIs\tmp'];
VOI_folder = 'F:\data\results_2nd_level\twottest\groupstats_MRT\NIFTI\PDT\results\ROIs\tmp';
cd(VOI_folder);
...
%     end
    ...
    for modelIt=1:1:length(ss_level.gppi.FirstLVLModel)
        ...
        for roiIt=1:1:length(ss_level.gppi.VOI)
            ...
            for indIt=1:1:length(indSearchIn)
