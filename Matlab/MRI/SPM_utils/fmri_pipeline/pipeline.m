...
sd_level.ttest.FirstLVLModel = {'MRT\NIFTI\PDT\results\PDT_ss_design_DEZ_sm_orth_glc\'; ...
...
sd_level.ttest.con = {'con_0002','con_0003','con_0004', ...
    'con_0006','con_0007', ...
    'con_0009','con_0010','con_0011','con_0012'}; % 
...
sd_level.ttest.conNames = {'Pic.gam','Pic.neg','Pic.pos', ...
    'Pic.Gam.Onxgain','Pic.Gam.Onxloss', ...
...
sd_level.twottest.FirstLVLModel = {'MRT\NIFTI\PDT\results\PDT_ss_design_DEZ_us_orth_val\'};
% -------------------------------------------------------------------------
% Define 1st Level Contrasts to each run Two-sample-Ttests for
sd_level.twottest.con = {'con_0002','con_0003','con_0004', ...
    'con_0006', ...
    'con_0007','con_0008','con_0009'};

sd_level.twottest.con = {'con_0001'};
...
% 1st Level Contrasts Names
sd_level.twottest.conNames = {'Pic.gam','Pic.neg','Pic.pos', ...
    'Pic.Gam.Onxval', ...
    'Pic.Gam.Onxvalxgam','Pic.Gam.Onxvalxneg','Pic.Gam.Onxvalxpos'};
sd_level.twottest.conNames = {'Pic.On'};
% -------------------------------------------------------------------------
% Indicate all groups that are included in the test
