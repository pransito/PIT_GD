...
sd_level.gen.sjinfo.path = ['C:\Users\' comp_name '\Google Drive\Library\MATLAB\PDT\MRI\sl\Sjinfo.mat'];
...
sd_level.gen.covarNames = {'SMOKE','EDUYRSSUM'};
%
%% ############### TTest ###############
...
sd_level.twottest.FirstLVLModel = {...
    'MRT\NIFTI\PDT\results\PDT_ss_design_DEZ_us_orth_val\PPI_Left_Accumbens',...
    'MRT\NIFTI\PDT\results\PDT_ss_design_DEZ_us_orth_val\PPI_Left_Amygdala',...
    'MRT\NIFTI\PDT\results\PDT_ss_design_DEZ_us_orth_val\PPI_Right_Accumbens',...
    'MRT\NIFTI\PDT\results\PDT_ss_design_DEZ_us_orth_val\PPI_Right_Amygdala',...
    'MRT\NIFTI\PDT\results\PDT_ss_design_DEZ_sm_orth_val\PPI_Left_Accumbens',...
    'MRT\NIFTI\PDT\results\PDT_ss_design_DEZ_sm_orth_val\PPI_Left_Amygdala',...
    'MRT\NIFTI\PDT\results\PDT_ss_design_DEZ_sm_orth_val\PPI_Right_Accumbens',...
    'MRT\NIFTI\PDT\results\PDT_ss_design_DEZ_sm_orth_val\PPI_Right_Amygdala'};
% -------------------------------------------------------------------------
...
sd_level.twottest.con = {'con_PPI_Pic.onxgam_','con_PPI_Pic.onxneg_','con_PPI_Pic.onxpos_', ...
    'con_PPI_Pic.gam.onxvalue_','con_PPI_Pic.gam.onxvalXgam_','con_PPI_Pic.gam.onxvalXneg_', ...
    'con_PPI_Pic.gam.onxvalXpos_'};
% 1st Level Contrasts Names
sd_level.twottest.conNames = {'PPI_Pic.gam','PPI_Pic.neg','PPI_Pic.pos', ...
    'PPI_Pic.Gam.Onxval','PPI_Pic.Gam.OnxvalXgam','PPI_Pic.Gam.OnxvalXneg', ...
    'PPI_Pic.Gam.OnxvalXpos'};
% -------------------------------------------------------------------------
% Indicate all groups that are included in the test
