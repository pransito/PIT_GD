...
sd_level.ttest.con = {'con_0001','con_0002','con_0003','con_0004', ...
    'con_0005','con_0006','con_0007','con_0008',...
    'con_0009','con_0010','con_0011','con_0012','con_0013'}; % 
% 1st Level Contrasts Names
sd_level.ttest.conNames = {'Pic.on','Pic.gam','Pic.neg','Pic.pos', ...
    'Pic.gam.on', 'Pic.gam.onxgain','Pic.gam.onxloss','Pic.gam.onxed', ...
    'Pic.gam.onxacc','Pic.gam.onxaccXgam','Pic.gam.onxaccXneg', ...
    'Pic.gam.onxaccXpos','Pic.gam.opt.on'};  % 
% -------------------------------------------------------------------------
% Indicate all groups that are included in the test
sd_level.ttest.numberOfGrp = {'1'};
%
...
sd_level.ttest.contrastNames = {'contrast1','contrast2'};
...
%sd_level.ttest.evalResROI = { 
 %   'F:\fMRI\prep\results_2nd_level\ROIs\ROIs\lbprob_frontal_midline_bilateral.nii'
  %  };
...
% sd_level.twottest.FirstLVLModel = {...
%     'MRT\NIFTI\PDT\results\PDT_ss_design_DEZ_us_orth_glc\PPI_Left_StrAso',...
%     'MRT\NIFTI\PDT\results\PDT_ss_design_DEZ_us_orth_glc\PPI_Left_StrAsoCaud',...
%     'MRT\NIFTI\PDT\results\PDT_ss_design_DEZ_us_orth_glc\PPI_Left_StrAsoPut',...
%     'MRT\NIFTI\PDT\results\PDT_ss_design_DEZ_us_orth_glc\PPI_Right_StrAso',...
%     'MRT\NIFTI\PDT\results\PDT_ss_design_DEZ_us_orth_glc\PPI_Right_StrAsoCaud',...
%     'MRT\NIFTI\PDT\results\PDT_ss_design_DEZ_us_orth_glc\PPI_Right_StrAsoPut', ...
%     'MRT\NIFTI\PDT\results\PDT_ss_design_DEZ_us_orth_glc\PPI_Left_Amygdala',...
%     'MRT\NIFTI\PDT\results\PDT_ss_design_DEZ_us_orth_glc\PPI_Left_Accumbens',...
...
sd_level.twottest.FirstLVLModel = {...
    'MRT\NIFTI\PDT\results\PDT_ss_design_DEZ_sm_orth_glc\PPI_Left_Amygdala',...
    'MRT\NIFTI\PDT\results\PDT_ss_design_DEZ_sm_orth_glc\PPI_Right_Amygdala',...
    'MRT\NIFTI\PDT\results\PDT_ss_design_DEZ_sm_orth_glc\PPI_Left_Accumbens',...
    'MRT\NIFTI\PDT\results\PDT_ss_design_DEZ_sm_orth_glc\PPI_Right_Accumbens',...
    };

% -------------------------------------------------------------------------
% Define 1st Level Contrasts to each run Two-sample-Ttes for
sd_level.twottest.con = {'con_PPI_Pic.onxgam_','con_PPI_Pic.onxneg_','con_PPI_Pic.onxpos_', ...
    'con_PPI_Pic.gam.onxgain_','con_PPI_Pic.gam.onxloss_', ...
    'con_PPI_Pic.gam.onxaccXgam_','con_PPI_Pic.gam.onxaccXneg_','con_PPI_Pic.gam.onxaccXpos_'};

% 1st Level Contrasts Names
sd_level.twottest.conNames = {'PPI_Pic.gam','PPI_Pic.neg','PPI_Pic.pos', ...
    'PPI_Pic.Gam.Onxgain','PPI_Pic.Gam.Onxloss', ...
    'PPI_Pic.Gam.OnxaccXgam','PPI_Pic.Gam.OnxaccXneg','PPI_Pic.Gam.OnxaccXpos'};
% -------------------------------------------------------------------------
% Indicate all groups that are included in the test
...
% -------------------------------------------------------------------------
% 2nd Level Contrasts
sd_level.twottest.contrastType    = {'t','t','t'};
...
if sd_level.twottest.on
    ...
    parfor (model=1:length(sd_level.twottest.FirstLVLModel),10)
    %for model=1:length(sd_level.twottest.FirstLVLModel)
