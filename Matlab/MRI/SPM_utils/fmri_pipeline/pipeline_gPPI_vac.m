...
sd_level.twottest.FirstLVLModel = {...
    'MRT\NIFTI\PDT\results\PDT_ss_design_DEZ_us_orth_vac\PPI_Left_Accumbens',...
    'MRT\NIFTI\PDT\results\PDT_ss_design_DEZ_us_orth_vac\PPI_Left_Amygdala',...
    'MRT\NIFTI\PDT\results\PDT_ss_design_DEZ_us_orth_vac\PPI_Right_Accumbens',...
    'MRT\NIFTI\PDT\results\PDT_ss_design_DEZ_us_orth_vac\PPI_Right_Amygdala',... 
    'MRT\NIFTI\PDT\results\PDT_ss_design_DEZ_sm_orth_vac\PPI_Left_Accumbens',...
    'MRT\NIFTI\PDT\results\PDT_ss_design_DEZ_sm_orth_vac\PPI_Left_Amygdala',...
    'MRT\NIFTI\PDT\results\PDT_ss_design_DEZ_sm_orth_vac\PPI_Right_Accumbens',...
    'MRT\NIFTI\PDT\results\PDT_ss_design_DEZ_sm_orth_vac\PPI_Right_Amygdala'};
% -------------------------------------------------------------------------
...
sd_level.twottest.con = {'con_PPI_Pic.onxgam_','con_PPI_Pic.onxneg_','con_PPI_Pic.onxpos_', ...
    'con_PPI_Pic.gam.onxvalue_','con_PPI_Pic.gam.onxcra_','con_PPI_Pic.gam.onxvalXcra_'};
% 1st Level Contrasts Names
sd_level.twottest.conNames = {'PPI_Pic.gam','PPI_Pic.neg','PPI_Pic.pos', ...
    'PPI_Pic.Gam.OnxVal','PPI_Pic.Gam.OnxCra','PPI_Pic.Gam.OnxValXCra'};
% -------------------------------------------------------------------------
% Indicate all groups that are included in the test
